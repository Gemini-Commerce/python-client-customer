...
class TestCustomerAddressDeleteResponse(unittest.TestCase):
    """CustomerAddressDeleteResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomerAddressDeleteResponse:
        """Test CustomerAddressDeleteResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomerAddressDeleteResponse`
        """
        model = CustomerAddressDeleteResponse()
        if include_optional:
            return CustomerAddressDeleteResponse(
                customer = customer.models.customer_customer_response.customerCustomerResponse(
    ...
    def testCustomerAddressDeleteResponse(self):
        """Test CustomerAddressDeleteResponse"""
