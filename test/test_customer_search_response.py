...
class TestCustomerSearchResponse(unittest.TestCase):
    """CustomerSearchResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomerSearchResponse:
        """Test CustomerSearchResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomerSearchResponse`
        """
        model = CustomerSearchResponse()
        if include_optional:
    ...
    def testCustomerSearchResponse(self):
        """Test CustomerSearchResponse"""
