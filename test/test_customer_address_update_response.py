...
class TestCustomerAddressUpdateResponse(unittest.TestCase):
    """CustomerAddressUpdateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomerAddressUpdateResponse:
        """Test CustomerAddressUpdateResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomerAddressUpdateResponse`
        """
        model = CustomerAddressUpdateResponse()
        if include_optional:
    ...
    def testCustomerAddressUpdateResponse(self):
        """Test CustomerAddressUpdateResponse"""
