...
class TestCustomerCustomerResponse(unittest.TestCase):
    """CustomerCustomerResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomerCustomerResponse:
        """Test CustomerCustomerResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomerCustomerResponse`
        """
        model = CustomerCustomerResponse()
        if include_optional:
    ...
    def testCustomerCustomerResponse(self):
        """Test CustomerCustomerResponse"""
