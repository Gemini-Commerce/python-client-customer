...
class TestCustomerUpdateRequestPayload(unittest.TestCase):
    """CustomerUpdateRequestPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomerUpdateRequestPayload:
        """Test CustomerUpdateRequestPayload
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomerUpdateRequestPayload`
        """
        model = CustomerUpdateRequestPayload()
        if include_optional:
            return CustomerUpdateRequestPayload(
    ...
    def testCustomerUpdateRequestPayload(self):
        """Test CustomerUpdateRequestPayload"""
