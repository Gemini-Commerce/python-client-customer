...
class CustomerAddressEntity(BaseModel):
    ...
    kind: Optional[CustomerAddressEntityKind] = CustomerAddressEntityKind.SHIPPING
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "kind": obj.get("kind") if obj.get("kind") is not None else CustomerAddressEntityKind.SHIPPING,
